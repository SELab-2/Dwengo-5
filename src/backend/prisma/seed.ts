...
async function createLearningObjects() {
    const learningObject1 = await prisma.learningObject.create({
        data: {
            ...
            estimated_time: 10,
            available: true,
            content_location: "nergens"
        }
    });

    const learningObject2 = await prisma.learningObject.create({
        data: {
