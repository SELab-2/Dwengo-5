...
export async function klas_leerkrachten(req: Request, res: Response, next: NextFunction) {
...
export async function klas_verwijder_leerkracht(req: Request, res: Response, next: NextFunction) {
    const classId = z.coerce.number().safeParse(req.params.klas_id);
