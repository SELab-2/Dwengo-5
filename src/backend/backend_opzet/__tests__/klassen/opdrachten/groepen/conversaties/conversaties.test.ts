...
describe("groepConversaties", () => {
  it("moet een lijst van conversaties teruggeven met statuscode 200", async () => {
    ...
    const response = await request(index).get(
      `/klassen/${classId}/opdrachten/${assignmentId}/groepen/${groupId}/conversaties`
    );
    ...
    expect(response.body).toEqual({
      leerlingen: [
        `/klassen/${classId}/opdrachten/${assignmentId}/groepen/${groupId}/conversaties/${conversationId}`,
      ],
    });
  });
  ...
  it("moet statuscode 400 terug geven bij een ongeldig classId", async () => {
    ...
    // verstuur het GET request
    const response = await request(index).get(
      `/klassen/abc/opdrachten/${assignmentId}/groepen/${groupId}/conversaties`
    );
  ...
  it("moet statuscode 400 terug geven bij een ongeldig assignmentId", async () => {
    ...
    // verstuur het GET request
    const response = await request(index).get(
      `/klassen/${classId}/opdrachten/abc/groepen/${groupId}/conversaties`
    );
  ...
  it("moet statuscode 400 terug geven bij een ongeldig groupId", async () => {
    ...
    // verstuur het GET request
    const response = await request(index).get(
      `/klassen/${classId}/opdrachten/${assignmentId}/groepen/abc/conversaties`
    );
...
describe("groepConversaties", () => {
  ...
  it("moet statuscode 400 terug geven bij een ongeldig classId", async () => {
    ...
    // verstuur het GET request
    const response = await request(index).get(
      `/klassen/abc/opdrachten/${assignmentId}/groepen/${groupId}/conversaties/${conversationId}`
    );
  ...
  it("moet statuscode 400 terug geven bij een ongeldig assignmentId", async () => {
    ...
    // verstuur het GET request
    const response = await request(index).get(
      `/klassen/${classId}/opdrachten/abc/groepen/${groupId}/conversaties/${conversationId}`
    );
  ...
  it("moet statuscode 400 terug geven bij een ongeldig groupId", async () => {
    ...
    // verstuur het GET request
    const response = await request(index).get(
      `/klassen/${classId}/opdrachten/${assignmentId}/groepen/abc/conversaties/${conversationId}`
    );
  ...
  it("moet statuscode 400 terug geven bij een ongeldig conversationId", async () => {
    ...
    // verstuur het GET request
    const response = await request(index).get(
      `/klassen/${classId}/opdrachten/${assignmentId}/groepen/${groupId}/conversaties/abc`
    );
  ...
  it("moet statuscode 500 teruggeven bij een interne fout", async () => {
    ...
    // simuleer een interne fout door de prisma methode te mocken
    vi.spyOn(prisma.classStudent, "findUnique").mockRejectedValueOnce(
      new Error("Internal Error")
    );
